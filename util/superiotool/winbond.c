...
static const struct superio_registers reg_table[] = {
	...
	{0x9771, "W83977F-A/G-A/AF-A/AG-A", {
		{NOLDN, NULL,
			...
			{0x97,0x71,0xff,0x00,MISC,0x00,MISC,0x00,MISC,0x00,0x00,
		...
		{0x3, "COM2",
			{0x30,0x60,0x61,0x70,0xf0,EOT},
			{0x01,0x02,0xf8,0x03,0x00,EOT}},
		{0x4, "RTC",
			{0x30,0x60,0x61,0x70,0x71,0xF0,EOT},
			{0x01,0x00,0x70,0x08,0x00,0x00,EOT}},
		{0x5, "Keyboard / mouse",
			{0x30,0x60,0x61,0x62,0x63,0x70,0x72,0xf0,EOT},
			{0x01,0x00,0x60,0x00,0x64,0x01,0x0c,0x40,EOT}},
		{0x6, "Infrared",
			{0x30,0x60,0x61,0x70,0x74,0x75,0xf0,EOT},
			{0x00,0x00,0x00,0x00,0x04,0x04,0x00,EOT}},
		{0x7, "GPIO 1",
			{0x30,0x60,0x61,0x62,0x63,0x64,0x65,0x70,0x72,0xe0,
			 0xe1,0xe2,0xe3,0xe4,0xe5,0xe6,0xe7,0xf1,EOT},
			{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,
