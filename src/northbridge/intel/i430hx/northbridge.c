...
static void i430hx_domain_read_resources(struct device *dev)
{
...
static struct device_operations pci_domain_ops = {
	.read_resources		= i430hx_domain_read_resources,
...
struct chip_operations northbridge_intel_i440bx_ops = {
	CHIP_NAME("Intel 82438HX (430HX) Northbridge")
