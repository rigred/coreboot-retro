 ...
 * expose the IT8679F SuperIO and some of its functionality.
 *  
 * PLACEHOLDER FILE, TODO SET ALL BIT TWIDDLES CORRECTLY
 *
...
#define SUPERIO_CHIP_NAME IT8679F
...
Device (FDC0)
{
	...
	{
		PNP_GENERIC_STA(IT8679F_FDC)
	}

	Method (_DIS, 0, NotSerialized) // _DIS: Disable Device
	{
		PNP_GENERIC_DIS(IT8679F_FDC)
	}
...
#define SUPERIO_UART_PM_LDN PNP_NO_LDN_CHANGE
	...
	#define SUPERIO_UART_LDN IT8679F_SP1
	...
	#define SUPERIO_UART_LDN IT8679F_SP2
...
#define SUPERIO_KBC_LDN IT8679F_KBC
