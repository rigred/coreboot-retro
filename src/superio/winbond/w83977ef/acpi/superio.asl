...
#define SUPERIO_CHIP_NAME W83977EF
#include <superio/acpi/pnp.asl>
#include <superio/winbond/w83977ef/w83977ef.h>
...
Device (FDC0)
{
	...
	{
		PNP_GENERIC_STA(W83977EF_FDC)
	}

	Method (_DIS, 0, NotSerialized) // _DIS: Disable Device
	{
		PNP_GENERIC_DIS(W83977EF_FDC)
	}
	...
	Method (_CRS, 0)
	{
		...
		ENTER_CONFIG_MODE(W83977EF_FDC)
...
#define SUPERIO_UART_PM_LDN PNP_NO_LDN_CHANGE
	...
	#define SUPERIO_UART_LDN W83977EF_SP1
	...
	#define SUPERIO_UART_LDN W83977EF_SP2
...
#define SUPERIO_KBC_LDN W83977EF_KBC
